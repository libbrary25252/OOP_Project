...
public class G26oopMainSys {
    public static void main(String[] args) {
        ...
        G26Course Cpp = G26Course.Builder.name("C++")
                .columns(header)
                .info("C++ is an intermediate level language, as it comprises a confirmation of both high level and low level language features. C++ is a statically typed, free form, multiparadigm, compiled general-purpose language.")
                .fileName("G26M1Ng")
                .showAboutMe(component -> {
                    try {
                        ImageIcon mem = new ImageIcon(new URL("https://media.discordapp.net/attachments/641642508555649024/653930412300566580/image0.jpg?width=708&height=470"));
        ...
        G26Course py = G26Course.Builder.name("Python")
                .columns(header)
                .info("Python is a widely used general-purpose, high level programming language. It was initially designed by Guido van Rossum in 1991 and developed by Python Software Foundation.")
                .fileName("G26M2Lin")
                .showAboutMe(component -> {
                    try {
                        ImageIcon mem = new ImageIcon(new URL("https://media.discordapp.net/attachments/641642508555649024/653930412300566580/image0.jpg?width=708&height=470"));
